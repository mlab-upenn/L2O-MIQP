...
def main():
    ...
    nn_model_1 = MLPWithSTE(insize=n_input, outsize=n_output,
                    ...
                    nonlin=nn.ReLU,
                    hsizes=[128] * 4)
    # nn_model_2 = MLPWithSTE(insize=n_input, outsize=n_output,
    #                 bias=True,
    #                 linear_map=torch.nn.Linear,
    #                 nonlin=nn.ReLU,
    #                 hsizes=[128] * 4)
    ...
    # Model_SL = SSL_MIQP_incorporated(nn_model_2, cplayer, 6, 4, device=device)
    ...
    # training_params['PATIENCE'] = 5
    # training_params['WANDB_PROJECT'] = "l2o_ssl_miqp_robot_nav"
    # training_params['RUN_NAME'] = "experiment_2_" + dt_string
    ...
    _ = Model_SSL.evaluate(test_loader)
    # _ = Model_SL.evaluate(test_loader)
